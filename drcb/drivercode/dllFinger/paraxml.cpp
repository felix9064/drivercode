				...
				if(strcmp(elem->Value(), DEVICEINFO) == 0 )
				{
					...
					if(pElem2)
					{
						while (pElem2)
						{
							...
							else if(strcmp(pElem2->Value(), THIRDMATCH) == 0)
							{
							...
							else if(strcmp(pElem2->Value(), CHECKDLL) == 0)
							{
								matchdll = pElem2->GetText();
							}
							...
							else if(strcmp(pElem2->Value(), THIRDDRVDLL) == 0)
							{
								thirddrvdll = pElem2->GetText();
							}
							else if (strcmp(pElem2->Value(), DEFTIMEOUT) == 0)
							{
                                timeout = atoi(pElem2->GetText());
							}
							else if(strcmp(pElem2->Value(), FINGERSERVERIP) == 0)
							{
								fingerserverip = pElem2->GetText();
							}
							else if(strcmp(pElem2->Value(), FINGERSERVERPORT) == 0)
							{
								fingerserverport = pElem2->GetText();
							}
							else if(strcmp(pElem2->Value(), SYSNO) == 0)
							{
								sysno = pElem2->GetText();
							}
							else if(strcmp(pElem2->Value(), VENDOR) == 0)
							{
								vendor = pElem2->GetText();
							}
